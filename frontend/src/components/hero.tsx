...
export default function Hero() {
	return (
		<div className="relative overflow-x-hidden overflow-y-visible px-4 pb-12 sm:pb-14">
			...
			<div className="mx-auto flex min-h-screen w-full max-w-(--breakpoint-xl) items-center justify-center px-4">
				<div className="relative z-10 max-w-3xl text-center">
					...
					<div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
						<Button
							className="rounded-full text-base font-semibold shadow-lg hover:shadow-xl transition-shadow px-5"
							size="lg"
						>
							Fillo një kauzë{" "}
						...
						<Button
							className="rounded-full text-base font-semibold border-accent/30 bg-accent/5 text-secondary-foreground hover:bg-accent/15 hover:text-primary shadow-md hover:shadow-lg transition-all px-5"
							size="lg"
							variant="outline"
						>
